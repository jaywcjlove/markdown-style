...
markdown-style kbd {
  ...
  padding: 3px 5px;
  font: 11px ui-monospace,SFMono-Regular,SF Mono,Menlo,Consolas,Liberation Mono,monospace,Helvetica,Arial,sans-serif;
  line-height: 10px;
  color: var(--color-fg-default);
...
markdown-style tt,
markdown-style code {
  font-family: ui-monospace,SFMono-Regular,SF Mono,Menlo,Consolas,Liberation Mono,monospace,Helvetica,Arial,sans-serif;
  font-size: 12px;
}
